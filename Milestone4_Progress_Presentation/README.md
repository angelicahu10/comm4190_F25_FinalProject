...
(other ideas were news analzyer, networker platform)

### Milstone 2

Created 6 usage scenarios
...
- Scenario 6: Content recommendation

### Milestone 3

Experimented with different prompting for each scenario, refining prompts to be more specific (tried chatgpt4.0, google gemini, etc.)
